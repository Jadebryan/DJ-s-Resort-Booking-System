...
return [
    ...
    */
    'staff_route_permissions' => [
        ...
        'tenant.bookings.update' => ['bookings', 'update'],
        'tenant.reports.index' => ['reports', 'read'],
        'tenant.reports.advanced' => ['reports', 'read'],
        ...
        'tenant.support.index' => ['support', 'read'],
        'tenant.support.tickets.store' => ['support', 'create'],
