...
<aside id="admin-sidebar"
    ...
    <button type="button"
            ...
            class="hidden h-10 w-full shrink-0 items-center justify-center border-b border-gray-100 bg-indigo-50/70 text-indigo-800 hover:bg-indigo-100/80 lg:flex"
        ...
        <ul class="space-y-0.5">
            <li>
                <a href="{{ route('admin.dashboard') }}" title="{{ __('Dashboard') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.dashboard') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.tenants.index') }}" title="{{ __('Tenants') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.tenants.*') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.tenant-registrations.index') }}" title="{{ __('Signups') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.tenant-registrations.*') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.payments') }}" title="{{ __('Payments') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.payments') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.maintenance') }}" title="{{ __('Maintenance') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.maintenance') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.reports') }}" title="{{ __('Reports') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.reports') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.subscriptions.index') }}" title="{{ __('Subscriptions') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.subscriptions.*') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.settings') }}" title="{{ __('Settings') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.settings') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ route('admin.profile.edit') }}" title="{{ __('Profile') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('admin.profile.*') ? 'bg-indigo-600 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
