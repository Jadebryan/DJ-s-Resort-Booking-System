...
@endphp
<div class="relative mb-5 rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-50/90 to-white px-4 py-3 shadow-sm sm:px-5 sm:py-4"
     x-data="{
    ...
    <div class="min-w-0 pr-10">
        <p class="text-[11px] font-semibold uppercase tracking-wide text-indigo-800">{{ __('Shortcuts & tips') }}</p>
