            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 overflow-hidden">
                <form method="POST" action="{{ tenant_url('rooms/' . $room->id) }}" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-tenant::text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $room->name)" required />
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-slate-300 bg-white text-slate-900 rounded-md shadow-sm focus:border-sky-500 focus:ring-sky-500 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200">{{ old('description', $room->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <x-tenant::text-input id="capacity" name="capacity" type="number" min="1" class="mt-1 block w-full" :value="old('capacity', $room->capacity)" />
                    ...
                    <div>
                        ...
                        <x-tenant::text-input id="price_per_night" name="price_per_night" type="number" step="0.01" min="0" class="mt-1 block w-full" :value="old('price_per_night', $room->price_per_night)" required />
