        ...
        <ul class="space-y-0.5">
            ...
            <li>
                <a href="{{ $url('/dashboard') }}" title="{{ __('Dashboard') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.dashboard') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/rooms') }}" title="{{ __('Rooms') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.rooms.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/bookings') }}" title="{{ __('Bookings') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.bookings.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/reports') }}" title="{{ __('Reports') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.reports.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/branding') }}" title="{{ __('Branding') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.branding.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/staff') }}" title="{{ __('Staff') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.staff.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/rbac') }}" title="{{ __('Access control') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.rbac.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/users') }}" title="{{ __('Users') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.users.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/domains') }}" title="{{ __('Domains') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.domains.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/payment') }}" title="{{ __('Payment') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.payment.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/settings') }}" title="{{ __('Settings') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.settings.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/profile') }}" title="{{ __('Profile') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.profile.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
