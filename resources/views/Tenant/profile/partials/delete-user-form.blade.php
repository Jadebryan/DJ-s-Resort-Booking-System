<section class="space-y-6">
    ...
    <x-tenant::modal name="confirm-user-deletion" maxWidth="md" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <x-form-with-busy method="post" action="{{ tenant_url('profile') }}" class="p-5 sm:p-6" :overlay="true" busy-message="{{ __('Deleting account...') }}">
            @csrf
            @method('delete')
