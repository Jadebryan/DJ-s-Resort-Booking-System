        ...
        <ul class="space-y-0.5">
            <li>
                <a href="{{ $url('/user/dashboard') }}" title="{{ __('Dashboard') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.user.dashboard') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-white/45 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/user/bookings') }}" title="{{ __('My Bookings') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.user.bookings.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-white/45 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
            ...
            <li>
                <a href="{{ $url('/user/profile') }}" title="{{ __('Profile') }}"
                   class="flex items-center gap-3 rounded-r-lg px-3 py-2.5 text-sm font-medium transition {{ $isActive('tenant.user.profile.*') ? 'bg-teal-500 text-white shadow-sm' : 'text-gray-600 hover:bg-white/45 hover:text-gray-900' }}"
                   :class="{ 'lg:justify-center lg:px-2': sidebarCollapsed }">
